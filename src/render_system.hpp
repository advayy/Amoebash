...
class RenderSystem
{
	...
	const std::array<std::string, texture_count> texture_paths = {
		...
		textures_path("ui_art/buttons/button_start.png"),
		textures_path("ui_art/buttons/button_resume.png"),
		textures_path("ui_art/buttons/button_info.png"),
		textures_path("ui_art/buttons/button_shop.png"),
		textures_path("ui_art/buttons/button_save.png"),
	};
