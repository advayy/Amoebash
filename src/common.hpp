...
const float PLAYER_MAX_DASH_SPEED = (2 * PLAYER_MAX_DASH_RANGE) / PLAYER_DASH_DURATION_MS;
const float PLAYER_DASH_DECELERATION = -1 * PLAYER_MAX_DASH_SPEED / PLAYER_DASH_DURATION_MS;
