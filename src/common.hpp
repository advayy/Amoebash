...
const float PLAYER_MAX_DASH_RANGE = 300;
const float PLAYER_DASH_DURATION_MS = 500.0f;
const float PLAYER_DASH_SPEED = PLAYER_MAX_DASH_RANGE / PLAYER_DASH_DURATION_MS;
const float PLAYER_DASH_DECELERATION = -1 * PLAYER_DASH_SPEED / PLAYER_DASH_DURATION_MS;

const float PLAYER_DASH_COOLDOWN_MS = 250;
const int64_t PLAYER_DASH_PRESS_MS = 0.3 * 1000;
const int64_t PLAYER_MAX_DASH_PRESS_MS = PLAYER_DASH_PRESS_MS * 2;
const int64_t PLAYER_MIN_DASH_PRESS_MS = PLAYER_DASH_PRESS_MS;
