...
Don’t worry if you die—you’ll always have the chance to regroup. Each time you fall, you’ll keep at least one of the buffs you’ve collected and get another shot at success. If you discover a powerful buff, it might give you the edge you need for your next attempt.

As you defeat enemies, you'll also earn "Germoney" that can be spent in the Shop to unlock new buffs or upgrade your ability to carry more buffs after each death. Every run counts, and no victory is ever truly wasted.
...
- **Menu Navigation:**  
  Left-Click on buttons to access the **Shop**, **Information Screens**, or to **Start the Game**.
- **In-Game Actions:**  
